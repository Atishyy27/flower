...
# ==============================================================================
"""Slack OAuth provider for Control connector flows."""
...
class SlackOAuthProvider:
    """Slack implementation of the Control OAuth provider contract."""
...
def get_configured_connector_oauth_providers() -> list[ConnectorOAuthProvider]:
