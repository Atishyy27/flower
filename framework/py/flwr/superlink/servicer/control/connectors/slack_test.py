...
# ==============================================================================
"""Tests for the Slack Control OAuth provider."""
...
def test_exchange_code_returns_user_credentials_and_workspace_config() -> None:
    ...
    with patch(
        "flwr.superlink.servicer.control.connectors.slack.requests.post",
...
def test_configured_provider_uses_environment(monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    assert providers[0].definition.connector_ref == "slack"
